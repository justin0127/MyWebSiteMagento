 ...
 */
class Rewardpoints_Block_Adminhtml_Rules_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            checkTarget = function(){
                if ($('rewardpoints_rule_type').getValue() == '".Rewardpoints_Model_Rules::TARGET_CART."'){
            ...
            changeOperator = function(){
                if ($('rewardpoints_rule_operator').getValue() == '".Rewardpoints_Model_Rules::OPERATOR_6."'){
                    if ($('span_from')){
