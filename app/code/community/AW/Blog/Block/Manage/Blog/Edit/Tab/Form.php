...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$fieldset->addField('identifier', 'text', array(
		  ...
		  'after_element_html' => '<span class="hint">(格式 : domain.com/blog/identifier)</span>',
		));
		...
		'after_element_html' => '<span class="hint">(在隐藏模式中，文章无法在博客中看到，但依然能够通过链接直接访问到。)</span>',
		));
		...
		'after_element_html' => '<span class="hint">(关闭模式下用户将无法发表评论)</span>',
		));
