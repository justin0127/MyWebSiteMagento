...
class Mage_Customer_Block_Address_Book extends Mage_Core_Block_Template
{
    ...
    public function getAddressHtml($address)
    {
        ...
        $address =  "<div class='AddressName'>".$address->getName()."</div><div class='AddressTel'>手机:".$address->getTelephone()."</div><div class='AddressStr'>"."中国".$address->getRegion().'省'.$address->getCity().$street['0']."</div><div class='AddressZip'>邮编:".$address->getPostcode()."</div>";
