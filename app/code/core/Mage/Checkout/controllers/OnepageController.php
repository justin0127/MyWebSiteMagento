...
class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
{
    ...
    public function saveShippingMethodAction()
    {
		...
		$this->addMoreProduct($post['sampleinfo'], $post['sample']);
        }		
	...
	$Customer = $this->getCustomer();
       ...
       // }    /*------  first buy cart empty------*/
	    ...
	    /*  gift message  */		
            ...
            /*  get fapiao title  */
            $FapiaoTitle = $fapiao;//$order->getFapiaoTitle(); 
            if($FapiaoTitle == '^^^') {
            $IsFapiao = 'No';
            }else{
            ...
            //Mage::log($products);
            $products = Mage::getSingleton('checkout/session')->getQuote()->getItemsCollection();
