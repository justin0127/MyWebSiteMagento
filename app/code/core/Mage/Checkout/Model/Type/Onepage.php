...
class Mage_Checkout_Model_Type_Onepage
{
    ...
    public function saveOrder($shipping_time='', $fapiao='')
    {
        ...
        if ($order) {
                //yaozer
        //Mage::log('in saveOrder : '. $shipping_time . $fapiao);
        ...
        $order->save();
			...
			if(0 && Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=="cashondelivery"){
				$redirectUrl="http://www.sisley.com.cn/checkout/onepage/success/";
				Mage::log('xxx');
