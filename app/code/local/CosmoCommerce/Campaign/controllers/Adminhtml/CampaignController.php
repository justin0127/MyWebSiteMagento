...
class CosmoCommerce_Campaign_Adminhtml_CampaignController extends Mage_Adminhtml_Controller_action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('campaign/items')
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->loadLayout();
			$this->_setActiveMenu('campaign/items');
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($campaignIds)) {
            ...
            try {
                foreach ($campaignIds as $campaignId) {
                    $campaign = Mage::getSingleton('campaign/campaign')
                        ->load($campaignId)
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('campaign/adminhtml_campaign_grid')
            ->getCsv();
