 ...
 * @category   Mage
 * @package    Mage_Alipay
 * @name       Mage_Alipay_Model_Payment
...
class Mage_Alipay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function getStandardCheckoutFormFields()
    {
		...
		$parameter = array(    
                           ...
                           'return_url'        => $this->getSuccessURL(),  //$this->getReturnURL(),
                           ...
                           'total_fee'         => sprintf('%.2f', $order->getBaseGrandTotal()),
                           'payment_type'      => '1',
