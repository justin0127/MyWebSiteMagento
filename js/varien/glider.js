...
Object.extend(Object.extend(Glider.prototype, Abstract.prototype), {
	...
	initialize: function(wrapper, options){
	    ...
	    this.sections   = this.wrapper.getElementsBySelector('.sectionslide');
	    this.options    = Object.extend({ duration: 1.0, frequency: 3, observeEvents: 1, useControls: 1  }, options || {});
