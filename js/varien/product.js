...
Product.Config.prototype = {
    initialize: function(config, money){
    ...
    configure: function(event){
        ...
        this.configureElement(element, param);
    },

    configureElement : function(element, param) {
    //alert(param);
...
//      Calculator.updatePrice();
    ...
    reloadPrice: function(param){
        ...
        optionsPrice.changePrice('config', price/param);
